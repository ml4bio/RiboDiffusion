...
def get_config():
    ...
    model.drop_struct = 0.1 # Changed from -1.0 for training
    ...
    train.epochs = 100
    train.batch_size = 16
    # train.learning_rate = 2e-4 # This is under optim
    train.dataset_path = './data/train'
    train.validation_dataset_path = './data/val'
    train.save_checkpoint_freq = 5  # In epochs
    train.num_workers = 4
    train.print_freq = 100 # In steps

    # optimization
    config.optim = optim = ml_collections.ConfigDict()
    optim.weight_decay = 0
    optim.optimizer = 'AdamW'
    optim.lr = 2e-4 # learning_rate is here
    optim.beta1 = 0.9
    optim.eps = 1e-8
    optim.warmup = 20000 # Number of warmup steps
    optim.grad_clip = 20.
    optim.disable_grad_log = False # Changed from True for training
